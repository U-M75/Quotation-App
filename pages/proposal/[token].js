...
export default function ProposalForm() {
    ...
    fetch(
      ...
      .then(async response => {
        ...
        if (!response.ok || !data.success) {
          throw new Error(
            data.error || 'Unable to load proposal'
          );
        }
  ...
  const submitProposal = async event => {
    ...
    try {
      ...
      if (!response.ok || !result.success) {
        throw new Error(
          result.error || 'Unable to submit proposal'
        );
      }
  ...
  return (
    <>
      <Head>
        <title>KSC Proposal Request Form</title>
        ...
        >
          ...
          {success && (
            ...
            >
              ...
              >
                The proposal details and PDF have been
